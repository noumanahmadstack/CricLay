...
import { updateLineupAction } from '../../../../../redux/scoring/normal/score/action';
import {
  onEditBatsman,
  onSelectBatter,
  onSelectBowler,
} from '../../../../../redux/scoring/normal/score/reducer';
import {
...
const TeamPlayers: FC<any> = ({ route }) => {
  ...
  const { balls, ballsPerOver, id } = currentInning || {};
  ...
  return (
    <PlayersTab
      ...
      onPressAddBtn={() => navigate('AddPlayers', { teamId: team_id })}
