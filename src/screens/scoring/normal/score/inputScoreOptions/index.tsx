...
import { onAddBalls } from '../../../../../redux/scoring/normal/score/reducer';
  ...
  return (
    <View>
      <WagonWheelForScorer
        ...
        onSkip={() => { dispatch(onAddBalls(selectedBall)), setIsVisibleScoreCardModal(false), setSelectedBall(ballInitialState) }}
        onConfirm={(data) => {
          setIsVisibleScoreCardModal(false),
            dispatch(onAddBalls({ ...selectedBall, ...data})),
